...
export type Data = {
    ...
    lavaResistanceActive: boolean,
    waterBreathingActive: boolean,
    isDead: boolean,
    kills: number,
    score: number,
}
...
PlayerData.DEFAULT_DATA = table.freeze({
    ...
    lavaResistanceActive = PlayerData.DEFAULTS.lavaResistanceActive,
    waterBreathingActive = PlayerData.DEFAULTS.waterBreathingActive,
